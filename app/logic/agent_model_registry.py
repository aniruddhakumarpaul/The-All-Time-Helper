...
FREE_AGENT_PRIMARY = "openrouter/nvidia/nemotron-nano-9b-v2:free"
FREE_AGENT_CLASSIFIER = "openrouter/nvidia/nemotron-nano-9b-v2:free"
...
CLOUD_MODEL_CONFIG = {
    ...
    "openrouter-free-code": {
        ...
        "classifier_model": FREE_AGENT_CLASSIFIER,
        "fallback_models": (FREE_AGENT_PRIMARY,),
        "key_envs": OPENROUTER_KEY_ENVS,
    },
    ...
    "openrouter-auto": {
        ...
        "classifier_model": FREE_AGENT_CLASSIFIER,
        "fallback_models": (FREE_AGENT_PRIMARY, "openrouter/cohere/north-mini-code:free"),
        "key_envs": OPENROUTER_KEY_ENVS,
    },
    ...
    "openrouter-kimi-code": {
        ...
        "classifier_model": FREE_AGENT_CLASSIFIER,
        "fallback_models": ("openrouter/cohere/north-mini-code:free", FREE_AGENT_PRIMARY),
        "key_envs": OPENROUTER_KEY_ENVS,
    },
